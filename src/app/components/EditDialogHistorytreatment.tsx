...
export default function EditDialogHistorytreatment({ open, onClose, onSuccess, history_id }: Props) {
        ...
        <Dialog open={open} onOpenChange={onClose} >
            <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto" >
                <DialogHeader className="text-center pb-4">
                    ...
                    <DialogTitle className="text-xl font-semibold">แก้ไขประวัติการรักษาของผู้ป่วย</DialogTitle>
                </DialogHeader>
